        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Favorites_AspNetUsers_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_VisitAppointments_AspNetUsers_TenantId",
                        column: x => x.TenantId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ApplicationDocuments_RentalApplications_RentalApplicationId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "role-admin", "stamp-admin", "Admin", "ADMIN" },
                    { "role-landlord", "stamp-landlord", "Landlord", "LANDLORD" },
                    { "role-tenant", "stamp-tenant", "Tenant", "TENANT" }
                });

            migrationBuilder.InsertData(
                table: "AspNetUsers",
                columns: new[] { "Id", "AccessFailedCount", "AccountStatus", "ConcurrencyStamp", "CreatedAt", "Email", "EmailConfirmed", "FullName", "LockoutEnabled", "LockoutEnd", "NormalizedEmail", "NormalizedUserName", "PasswordHash", "PhoneNumber", "PhoneNumberConfirmed", "Role", "SecurityStamp", "TwoFactorEnabled", "UserName" },
                values: new object[] { "admin-user-id", 0, 1, "STATIC-CONCURRENCY-STAMP", new DateTime(2026, 1, 1, 0, 0, 0, 0, DateTimeKind.Utc), "admin@rentvibe.com", true, "System Admin", false, null, "ADMIN@RENTVIBE.COM", "ADMIN@RENTVIBE.COM", "AQAAAAIAAYagAAAAEMNUmxzgRfC6v08KqKzYSSAkBpywkUtQlbjR/b/v9tUNqpqOqL+SZWeTNoOc6OlwHg==", null, false, 2, "STATIC-SECURITY-STAMP", false, "admin@rentvibe.com" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationDocuments_RentalApplicationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Properties_RentalStatus",
                table: "Properties",
                column: "RentalStatus");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VisitAppointments_TenantId",
                table: "VisitAppointments",
                column: "TenantId");
        }
